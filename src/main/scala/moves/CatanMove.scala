...
import board.{Edge, Vertex}
import core.Roll
import inventory.resources.CatanResourceSet.{CatanResourceSet, Resources}
import inventory.resources.Steal
import inventory.{DevelopmentCard, Resource}
...
sealed trait ImperfectInformation
  ...
  //case object PointMove extends moves.CatanPlayCardMove[]