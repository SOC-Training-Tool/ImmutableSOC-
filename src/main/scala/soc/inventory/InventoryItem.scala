...
sealed trait Port {val value: Int}
sealed abstract class Resource(val value: Int, val name: String) extends InventoryItem
...
case object Misc extends Port {val value = 0}
